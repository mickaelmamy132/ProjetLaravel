    ...
    <main>
        ...
        <div class="table-data">
            <div class="todo">
                ...
                <form action="{{ URL::to('index/tableCondamner/ajoutCondamner/ajoutcondamn/'.$prevenus->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <h3>les modifications apres jugement</h3>
                    <p> <strong> le prevenu nomme:</strong> {{ $prevenus->nom }} {{ $prevenus->prenom }} accusé de: {{ $prevenus->inculpation }}</p>
                    </p>
                    ...
                    <div class="form-input form-input-group">
                        ...
                        <select name="status" id="" required disabled>
                            <option value="">...</option>
                            <option value="Emprisonnement" {{$statut === 'Emprisonnement' ? 'selected' : ''}} >Emprisonnement</option>
                            <option value="Travaux Force" {{$statut === 'Travaux Force' ? 'selected' : ''}} >Travaux Force</option> 
                        </select>
